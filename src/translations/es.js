export const es = {
  ...
  about: {
    title: 'Sobre mí',
    carrer: 'Ingeniero en Electrónica, Control y Redes Industriales',
    description1: 'con más de ocho años de experiencia en sistemas embebidos, automatización industrial y desarrollo full-stack. He liderado proyectos de investigación y desarrollo que integran: inteligencia artificial, visión por computadora y experiencias inmersivas para ofrecer soluciones innovadoras en entornos industriales y académicos.',
    btnGet: 'Ponte en contacto',

    subtitle1: 'Sistemas Embebidos',
    description2: 'Desarrollo de sistemas basados en microcontroladores y FPGA con experiencia en Robótica, IoT, ROS2, RTOS y Linux',
    ...
    subtitle3: 'Desarrollo Full-Stack',
    description4: 'Desarrollo de aplicaciones web, móviles y de escritorio, diseño UX/UI, manejo de bases de datos (SQL/NoSQL)',
    ...
    description6: 'Modelado 3D con herramientas CAD para crear prototipos con experiencias inmersivas en realidad extendida (VR/AR/MR).',
  },
  ...
  projects: {
    ...
    project4: {
      title: 'HMI para turbinas hidráulicas',
      description: 'Sistema de adquisición de datos para procesos de mantenimiento predictivo.'
    },
  ...
  contact: {
    ...
    description: '¿Listo para llevar tu proyecto al siguiente nivel? Escríbeme. Estoy abierto a propuestas de trabajo, colaboraciones o consultas técnicas en cualquier momento.',
    ...
    ToastTitle: 'Mensaje enviado con éxito',
